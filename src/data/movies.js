const data = [
    ...
    },
    {
        ...
        "cover": "avatar.png",
        "title": "Parasite",
        "description": "Avatar (2009) is a sci-fi epic by James Cameron, set on the lush alien world of Pandora, where humans clash with the native Na’vi. Stunning visuals and a powerful environmental message define this groundbreaking film.",
        "genre": "Action/Adventure/Sci-fi",
        "rating": 4,
        "price": 300
    }
